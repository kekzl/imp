// Vendored from vLLM csrc/libtorch_stable/quantization/marlin/gptq_marlin_repack.cu
// (Apache-2.0, vLLM project / IST-DASLab Marlin). Kernel body verbatim;
// the torch-stable entry point is replaced by the imp-native prepare() in
// marlin_repack.cu.
#pragma once
#include "marlin.cuh"
