...
SchedulerTest.AdmissionGateCancelsAnAgedRequestWhenNothingIsRunning
SchedulerTest.AdmissionGateHoldsTheWholeRound
SchedulerTest.AdmissionReservesGeneration
SchedulerTest.AgingDoesNotCrossPriorityClasses
SchedulerTest.AgingStillBoundsStarvationWithinAClass
SchedulerTest.AgingStopsALongPromptFromStarving
SchedulerTest.AllRequestsTooLargeForMemory
SchedulerTest.AnAgedRequestHoldsTheQueueUntilItsBlocksAreFree
SchedulerTest.EqualPriorityFallsBackToShortestFirst
...
SchedulerTest.NothingRunningAdmitsAFittingPrompt
SchedulerTest.PrefillPriorityOverDecode
SchedulerTest.PriorityBeatsShortestFirst
SchedulerTest.ShortestFirstStillHoldsAmongPeers
SchedulerTest.RemovesFinishedRequests
SchedulerTest.ShortestInputFirst
StoragePlanner.DualPathHintRoutesCorrectly
StoragePlanner.EntryCarriesSourceQtype
StoragePlanner.EnumeratesSharedExpertFFN
StoragePlanner.EnumeratesTopLevelEmbeddingsAndLMHead
StoragePlanner.F16SourceDoesNotPickNVFP4
StoragePlanner.GDNGateIsNotEnumeratedForOverlay
StoragePlanner.GenerousBudgetPreservesInitialTiers
StoragePlanner.NativeNVFP4SourceMandatesNVFP4Tier
StoragePlanner.NativeNvfp4SourcesCostNothingAtNvfp4Tier
StoragePlanner.ProjectedVRAMMatchesEntrySum
StoragePlanner.Q4KSourceDoesNotPickNVFP4UnderPreferHint
StoragePlanner.Q6KSourcePreservesNVFP4UnderPreferHint
StoragePlanner.TinyBudgetReturnsFailure
WeightRegistryPreservation.NVFP4ModeDoesNotDowngradeSSMInOut
