...
### Changed
- Dockerfile: the runtime stage drops the CUDA apt source before `apt-get update` (it only installs curl and jq from Ubuntu); NVIDIA's ubuntu2604 index shipped 5 malformed sections on 2026-09-16 and broke every `make build`.
