...
This is not a wrapper around an existing engine. imp implements its own GGUF parser, tokenizer, KV cache, attention kernels (scalar, WMMA, TCGEN05), quantized GEMV kernels (dp4a), MoE routing, speculative decoding, CUDA Graphs, and more — all targeting NVIDIA Hopper (sm_90a) and Blackwell (sm_100, sm_120) GPUs with CUDA 13.1.
