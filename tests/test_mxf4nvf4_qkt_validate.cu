...
static float e2m1_ref(float v) {
    float a = fabsf(v);
    int mag = (a >= 0.25f) + (a >= 0.75f) + (a >= 1.25f) + (a >= 1.75f) + (a >= 2.5f) + (a >= 3.5f) +
              (a >= 5.0f);
...
static void run_and_compare(const std::vector<half>& h_Q, const std::vector<half>& h_K,
...
TEST(Mxf4nvf4QkTest, RowIndicator) {
    ...
    const float expected_per_row[16] = {0 * 64.0f,  0.5f * 64,  1 * 64.0f,  1.5f * 64,
                                        2 * 64.0f,  3 * 64.0f,  4 * 64.0f,  6 * 64.0f,
                                        -0.5f * 64, -1 * 64.0f, -1.5f * 64, -2 * 64.0f,
                                        -3 * 64.0f, -4 * 64.0f, -6 * 64.0f, 2 * 64.0f};
