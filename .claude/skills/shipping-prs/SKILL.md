...
- **Plain punctuation: no em dashes**, in the CHANGELOG and in the release body. A colon, a comma or a full stop says the same thing. When you replace one, re-read the sentence: `X — Y` often becomes a comma splice, and the fix is a colon or a full stop, not a comma.
