...
0. ~~**Concurrency scaling on the GDN hybrid vs vLLM: 1.58x gap at 32 streams,
   ...
   at 32 with 1082-token prompts; Qwen3-14B-NVFP4 +7.9% at 8 but -7.6% at 32 and -41.0% at 32 with
   ...
   dense decode attention at ~1k context (`paged_attention_decode_fp8`, 33%
   of the kernel time at 32 x 1.1k, ~25% of bandwidth) and the paced
   serving prefill (31.4k prompt tokens in ~2 s under decode against
   26k tok/s standalone). auto=28 vs pinned=32
