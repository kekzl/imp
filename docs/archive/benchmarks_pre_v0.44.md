...
# Benchmarks: full record through v0.44.0 (pre-rewrite)

Record. The whole of [`BENCHMARKS.md`](../BENCHMARKS.md) as it stood at commit `9cbb8004`
(verified 2026-09-13), moved here verbatim in the 2026-09-22 docs rewrite: every superseded
competitive sweep, the imp-vs-vLLM concurrency progression and the batched-decode
optimization history, kept for provenance. Current numbers:
