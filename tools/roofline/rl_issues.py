...
# SKIP_CLASSES: low %-roofline here is a workload artifact or noise floor, not an actionable
# lever (documented in the audit report's "Known artifacts" section) - kept out of issues.
