...
// OpenAI + Anthropic chat endpoints: handle_chat_completions (/v1/chat/completions),
// handle_completions (/v1/completions), and handle_messages (/v1/messages).
// Streaming/parse machinery lives in handlers_chat_core.cpp / handlers_chat_stream.cpp
