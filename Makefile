...
test-e2e: build
	docker run --rm --gpus all -v $(HOME)/models:/models \
		...
		$(DOCKER_IMG) imp-tests --gtest_filter="PrimaryModelTest.*:GDNModelTest.*:EndToEndModelTest.*:Gemma4ModelTest.*:Gemma4GraphsTest.*:SpecCaptureFidelityTest.*:DeviceFaultSignalTest.*:ServingSignalsTest.*:SamplerRowBansTest.*:*DetEvalE2ETest*"
